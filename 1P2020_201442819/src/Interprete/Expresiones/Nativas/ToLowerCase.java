 ...
 * @author Jerduar
 */
public class ToLowerCase extends CallFun{
    
    public ToLowerCase(LinkedList<Expresion> p, Integer fila, Integer col) {
        super("ToLowerCase", p, fila, col);
    }
    ...
    public Object Resolver(TablaSimbolos t) {
        ...
        return new VectorArit(TipoPrimitivo.STRING, cad.toLowerCase());
    }
