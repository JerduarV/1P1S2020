...
/**
 * Clase para manejar la lógica de la operación módulo
 * @author Jerduar
 */
public class Modulo extends Operacion{
     ...
     */
    public Modulo(Integer fila, Integer col, Expresion izq, Expresion der) {
    ...
    public Object Resolver(TablaSimbolos t) {
        ...
        if (val_izq instanceof VectorArit && val_der instanceof VectorArit) {
            ...
            if (vector_izq.getTamanio() == 1 && vector_der.getTamanio() == 1) {
                return ModuloVectoresBase(vector_izq, vector_der);
            }
        }
