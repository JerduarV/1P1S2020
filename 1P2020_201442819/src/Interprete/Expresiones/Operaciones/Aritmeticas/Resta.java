...
/**
 * Clase para menejar la lógica de las restas en el lenguaje
 *
 * @author Jerduar
 */
public class Resta extends Operacion {
    ...
    /**
     * Constructor de una Operación de sustracción
     *
     ...
     */
    public Resta(Integer fila, Integer col, Expresion izq, Expresion der) {
    ...
    public Object Resolver(TablaSimbolos t) {
        ...
        if (val_izq instanceof VectorArit && val_der instanceof VectorArit) {
            ...
            if (vector_izq.getTamanio() == 1 && vector_der.getTamanio() == 1) {
                return RestaVectoresBase(vector_izq, vector_der);
            }
        }
