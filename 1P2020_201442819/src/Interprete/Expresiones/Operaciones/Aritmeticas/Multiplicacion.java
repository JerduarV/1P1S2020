...
/**
 * Clase que maneja la lógica de la multiplicación en el lenguaje
 * @author Jerduar
 */
public class Multiplicacion extends Operacion{

    /**
     * Constructor de la clase multiplicación
     * @param fila Fila en la que se encuentra
     * @param col columna en la que se encuentra
     * @param izq operador izquierdo
     * @param der operador derecho
     */
    public Multiplicacion(Integer fila, Integer col, Expresion izq, Expresion der) {
    ...
    public Object Resolver(TablaSimbolos t) {
        ...
        if (val_izq instanceof VectorArit && val_der instanceof VectorArit) {
            ...
            if (vector_izq.getTamanio() == 1 && vector_der.getTamanio() == 1) {
                return MultiplicacionVectoresBase(vector_izq, vector_der);
            }
        }
