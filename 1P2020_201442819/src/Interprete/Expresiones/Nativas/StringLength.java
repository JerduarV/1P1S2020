...
/**
 * Clase que cumple la función nativa de StringLength
 * @author Jerduar
 */
public class StringLength extends CallFun {

    public StringLength(LinkedList<Expresion> p, Integer fila, Integer col) {
        super("StringLength", p, fila, col);
    }
    ...
    public Object Resolver(TablaSimbolos t) {
        ...
        return new VectorArit(TipoPrimitivo.INTEGER, cad.length());
    }
